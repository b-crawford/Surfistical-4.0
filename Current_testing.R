...
if(start_month == month & (start_day - 1 == day | start_day - 2 == day | start_day - 3 == day)){
  mens_go_time = 1
}
...
if(mens_go_time == 1){
  ...
  comp = html_nodes(s,'.results-details-heat-bd--athletes-3 .athlete-name')
  
  comp = html_text(comp)
  
  heat_nodes = html_nodes(s,'.results-details-heat-num')
  
  heat_text = html_text(heat_nodes)
...
#results-details-heat-63358 .athlete-name
#results-details-heat-63358 .athlete-name
